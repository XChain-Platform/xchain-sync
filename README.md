...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-2%2C520%2B%20passing-brightgreen" alt="Tests">
...
| `npm test` | Run unit tests (2,032 tests) |
...
| `npm run test:regression` | Unit tests tagged `@regression` (528 tests) |
