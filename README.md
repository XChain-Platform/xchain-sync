...
| `npm test` | Run unit tests (2,280 tests) |
...
| `npm run test:regression` | Unit tests tagged `@regression` (587 tests) |
...
| `npm run test:chaos` | Chaos engineering tests (DB failures, network partitions, 41 tests) |
