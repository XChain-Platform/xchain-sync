...
// Hard-exit budget for the whole drain. xchain-node stops a sync service with a
...
function resolveTimeoutMs(timeoutMs, env){
    ...
    const raw = parseInt((env || envConfig.envSource()).SHUTDOWN_TIMEOUT_MS, 10);
