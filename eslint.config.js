 ...
 *
 * This is a vendored copy of the platform's master preset, taken by COPY
 * because a public clone has no private tree to import from. Core rules only,
 * no plugins, so it has one dependency: eslint ^9, added in the same commit.
 * Edit the master and re-vendor; a local edit here is drift.
 *
