...
describe('Integration: the follower at an armed height, and a reorg across it', function() {
    ...
    it('leaves both activation maps exactly as it found them', function() {
        ...
        // wiped them. All three testnet chains joined at GENESIS (2026-08-20),
        // replacing BTC:testnet's 146500; a new arming lands here too, so this
        // pin moves with the real map on purpose.
        assert.deepStrictEqual(SUB.STATE_SUBTREE_ACTIVATION.contract_state_root,
                               { 'BTC:regtest': 10000, 'BTC:testnet': 0,
                                 'LTC:testnet': 0, 'DOGE:testnet': 0 },
