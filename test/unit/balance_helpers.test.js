...
function registerRebuildBalancesTests(getDb) {
...
function registerScopedRebuildTests(getDb) {
...
function registerRecomputeUpdateTests(precisionDb) {
...
function registerRecomputeRenderingTests(precisionDb) {
...
function registerRecomputeGuardTests(precisionDb) {
...
describe('balance-helpers @money @regression', function () {
    ...
    describe('rebuildBalances()', function () {
        ...
        registerRebuildBalancesTests(() => db);
    });
    ...
    describe('recomputeTokenSupplies() @money @regression', function () {
        ...
        registerRecomputeUpdateTests(precisionDb);
        registerRecomputeRenderingTests(precisionDb);
        registerRecomputeGuardTests(precisionDb);
    });
