...
function registerZeroValueTests(){
...
function registerNegativeValueTests(){
...
function registerInvalidValueTests(){
...
function registerFloatingPointTests(){
...
function registerLargeValueTests(){
...
function registerSourceListTests(){
...
function registerPortBoundaryTests(){
...
describe('Boundary: Config Parsing', function(){
    ...
    registerZeroValueTests();
    registerNegativeValueTests();
    registerInvalidValueTests();
    registerFloatingPointTests();
    registerLargeValueTests();
    registerBooleanTests();
    registerSourceListTests();
    registerPortBoundaryTests();
});
