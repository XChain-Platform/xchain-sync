...
const { collectDerivedAnchorRewards: collectFromRealFake } = require('../../src/server/derived_rewards');
...
const collectDerivedAnchorRewards = (db, ...rest) => collectFromRealFake(Object.assign(db, REWARDS_MIXIN), ...rest);
