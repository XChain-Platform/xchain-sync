...
// like it did.
//
// Six guards in test/unit are byte-identity or value-parity checks against a
// SIBLING checkout (the consensus twins against xchain-indexer, the vendored
// coins registry against xchain-hub, the state-subtree activation copy against
// xchain-sdk and xchain-explorer, and so on). Every one of them resolves its
...
// this repo's then-declared siblings ran 1709 passing / 12 pending where the
// full checkout runs 1717 / 4, so 8 guards had silently not run.
//
...
const SIBLINGS = [
    { repo: 'xchain-documentation', envs: ['XCHAIN_DOCS_DIR'],
      marker: 'protocol',
      guards: 'consensus-primitive conformance and the state-commitment reference' },
