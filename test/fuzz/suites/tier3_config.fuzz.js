...
const { envVarString } = require('../helpers/generators/values');
...
const REQUIRED_KEYS = [
    ...
    'SYNC_SOURCES', 'VERIFY_HASHES',
    'REPLICA_DB_HOST', 'REPLICA_DB_PORT', 'REPLICA_DB_USER', 'REPLICA_DB_PASS',
    'HUB_REPOLL_INTERVAL', 'WS_BACKPRESSURE_MAX_BYTES', 'WS_BACKPRESSURE_STALL_MS',
    'WS_STATUS_INTERVAL',
...
const HARDCODED = {
    ...
    // WS_BACKPRESSURE_LIMIT (count-based) was retired for byte-based backpressure
    // (item 5410); config.js now defaults these two (not env-fuzzed here).
    WS_BACKPRESSURE_MAX_BYTES: 16777216, // 16 MiB
    WS_BACKPRESSURE_STALL_MS: 30000,     // 30 s
