...
describe('E2E: Transparency Log', function() {
    ...
    describe('8.1 Transparency log populated during sync', populatedDuringSync);

    describe('8.2 Transparency log after reorg', afterReorg);

    describe('8.3 Transparency log pagination', pagination);

    describe('8.4 Merkle inclusion proof round-trip', merkleProofRoundTrip);

    describe('8.5 Root/latest empty log', emptyLog);
});
