...
function incrementalCatchUp200Blocks() {
...
function singleBlockManyActions() {
...
function snapshotDownloadLargeDataset() {
...
describe('E2E: Large Data Volume', function() {
    ...
    describe('6.1 Bootstrap with 500 blocks', bootstrap500Blocks);

    describe('6.2 Incremental catch-up of 200 blocks', incrementalCatchUp200Blocks);

    describe('6.3 Single block with many actions', singleBlockManyActions);

    describe('6.4 Sustained throughput', sustainedThroughput);

    describe('6.5 Snapshot download for large dataset', snapshotDownloadLargeDataset);
});
